    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button className="bg-blue-600 text-white px-3 py-1.5 text-sm rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-1.5">
          ...
          <nav className="flex space-x-6 px-4" aria-label="Tabs">
            {[
              ...
              <button
                ...
                } whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm flex items-center space-x-1.5 transition-colors`}
              >
